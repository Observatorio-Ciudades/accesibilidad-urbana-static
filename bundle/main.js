...
function init() {   
    ...
    async function loadHexData(city, serv) {
        ...
        let responseCSV = await d3.csv(`${city}_data.csv`);
              ...
              switch(response.index) {
                case 0: 
                    ...
                    if (!pathAOn) {
                        ...
                        renderPaths("edges_route_min_02.json", "pathA", 0.07);
                        pathAOn = true;
                    }
                    break;
                ...
                case 2: 
                    ...
                    if (!pathBOn) {
                        ...
                        renderPaths("edges_route_max_03.json", "pathB", 0.37);
                        pathBOn = true;
                    }
                    break;
